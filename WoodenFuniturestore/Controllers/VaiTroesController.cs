...
namespace WoodenFuniturestore.Controllers
{
    public class VaiTroesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("VaiTroId,TenVaiTro")] VaiTro vaiTro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VaiTroId,TenVaiTro")] VaiTro vaiTro)
        {
        ...
        {
            return _context.VaiTros.Any(e => e.VaiTroId == id);
        }
    }
}
